...
public class GameRoutes {
    ...
    public static long dfs(int v,int n,ArrayList<ArrayList<Integer>> adj,long dp[]){
        if(v == n-1){
            return 1;
        }
        ...
        for(int i=0;i<adj.get(v).size();i++){
            cnt=(cnt%mod+dfs(adj.get(v).get(i),n,adj,dp)%mod)%mod;
        }
        return dp[v]=cnt%mod;
    }
    public static void main(String[] args) throws java.lang.Exception {
        ...
        long dp[]=new long[n];
        Arrays.fill(dp, -1);
        System.out.println(dfs(0,n,adj,dp));
    }
}